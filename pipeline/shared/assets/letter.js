...
(function () {
  ...
  var STATUTE = {
    ...
    responseSection: "{{statute.response_section}}",
    responseWindow: "{{statute.response_window}}",
    feeSection: "{{statute.fee_section}}",
    feeThreshold: "{{statute.fee_threshold}}",
    appealBody: "{{statute.appeal.body}}",
    city: "{{city}}",
    state: "{{state}}"
  };
